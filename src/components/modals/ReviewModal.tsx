...
import { REPUTATION_CONFIG, getRockImageUrl } from '@/constants'
...
export function ReviewModal({ trade, onClose, onSubmit }: ReviewModalProps) {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Review rock" className="fixed inset-0 z-[60] bg-black/80 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
      <div
        {...swipeProps}
      ...
      >
        ...
        <div className="p-4 space-y-5">
          ...
          <div className="bg-stone-800/50 rounded-xl p-3 flex items-center space-x-3">
            <img
              src={getRockImageUrl(trade.targetRock)}
